...
class _AllCustomersScreenState extends State<AllCustomersScreen> {
  Future callCustomers(int page, PagingController _controller,
    ...
    String url = Uri.encodeFull(
        '...?page=$page&title=$title&authorized=$authorized&step=&package=&dashboard_filter_type=hepsi&selected_package_type=hepsi');
  ...
  Widget build(BuildContext context) {
    return CommonListCCWidget(getData: callCustomers);
  }
}
