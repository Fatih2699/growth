...
class PosRaporScreen extends StatefulWidget {
  const PosRaporScreen({Key? key}) : super(key: key);

  @override
  State<PosRaporScreen> createState() => _PosRaporScreenState();
}

class _PosRaporScreenState extends State<PosRaporScreen> {
  Future callPosRapor(int page, PagingController _controller,
    ...
    String url = Uri.encodeFull(
        '...?page=$page&title=$title&authorized=$authorized&step=&package=&dashboard_filter_type=hepsi&selected_package_type=fiziksel_pos');
