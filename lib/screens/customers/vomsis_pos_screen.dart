...
class VomsisPosScreen extends StatefulWidget {
  const VomsisPosScreen({Key? key}) : super(key: key);

  @override
  State<VomsisPosScreen> createState() => _VomsisPosScreenState();
}

class _VomsisPosScreenState extends State<VomsisPosScreen> {
  Future callPosRapor(int page, PagingController _controller,
    ...
    String url = Uri.encodeFull(
        '...?page=$page&title=$title&authorized=$authorized&step=&package=&dashboard_filter_type=hepsi&selected_package_type=vomsis_pos');
  ...
  Widget build(BuildContext context) {
    return CommonListCCWidget(getData: callPosRapor);
  }
}
